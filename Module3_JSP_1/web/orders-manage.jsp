...
<script>
    function clearDate() {
        document.getElementsByName("txtStartOrderDate").value = "";
        document.getElementsByName("txtEndOrderDate").value = "";
                        ...
                        <c:otherwise>
                            <c:forEach items="${orderList}" var="order">
                                <tr>
                                    ...
                                    <c:choose>
                                        <c:when test="${order.getShippedDate() eq null && check eq true}">
                                            <td style="color: blue;">Pending | <a href="#">Cancel</a></td>
                                            <c:set var="check" value="${false}"/>
                                        </c:when>
                                        <c:when test="${order.getRequiredDate() eq null && check eq true}">
