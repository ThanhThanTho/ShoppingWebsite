...
public class ForgotPassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (email.equals("")) {
            ...
            //gui mail thong tin pass moi cho ng dung
            EmailSender mail = new EmailSender();
            if (mail.sendEmail(email)) {
                req.setAttribute("emailSent", "New Password has been sent to your email");
            }
            else req.setAttribute("emailSentFail", "Something wrong with email sender. Please try another network connection");
        }
        req.getRequestDispatcher("../forgot.jsp").forward(req, resp);
    }
