...
public class HomeFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (uri.endsWith(".jsp")) {
            String url = contextPath + "/index";
            resp.sendRedirect(url);
        }
        
        if (req.getSession().getAttribute("AdmSession")!=null) {
            req.setAttribute("cateList", new CategoryDAO().getCategories());
        }
        
        if (req.getSession().getAttribute("deleteFail") != null && isReloaded(req)) {
            i++;
        }
        if (i == 2) {
            i=0;
            req.getSession().removeAttribute("deleteFail");
        }
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("HomeFilter(");
