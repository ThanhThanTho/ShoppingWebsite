...
public class Product {
    ...
    public Product(String ProductName, int CategoryID, String QuantityPerUnit, double UnitPrice, int UnitsInStock, int UnitsOnOrder, int ReorderLevel, boolean Discontinued) {
    ...
    public String getCategoryName(){
        ...
        for (int i = 0; i < list.size(); i++) {
            if (this.CategoryID == list.get(i).getCategoryID()) {
    ...
    public String toString() {
        ...
        ProductName + ", CategoryID=" + CategoryID + ", QuantityPerUnit=" + 
        QuantityPerUnit + ", UnitPrice=" + UnitPrice + ", UnitsInStock=" + 
        UnitsInStock + ", UnitsOnOrder=" + UnitsOnOrder + ", ReorderLevel=" + ReorderLevel + ", Discontinued=" + Discontinued + '}';
    }
